...
เวอร์ชันนี้รองรับคะแนน **-0.50 ถึง 3.00 เพิ่มครั้งละ 0.25**, เรียงรายชื่อแบบภาษาไทย ก–ฮ, จัดเรียงตารางสรุป, เพิ่ม/แก้ไข/ลบพนักงาน, บันทึกคะแนนให้ **พนักงานทุกคน** และค้นหารายการย้อนหลังตามพนักงานหรือวันที่ได้
...
- **ป้อนข้อมูล**: เลือกวันที่ พนักงาน สถานะ และคะแนน 5 หัวข้อ โดยเลือก “พนักงานทุกคน” เพื่อใช้คะแนนและหมายเหตุเดียวกันกับพนักงานที่เปิดใช้งานทั้งหมดได้
...
### การใช้ตัวเลือก “พนักงานทุกคน”

1. เปิดหน้า **ป้อนข้อมูล** และเลือก `★ พนักงานทุกคน`
2. เลือกวันที่ สถานะ คะแนน และหมายเหตุ
3. กดปุ่ม **บันทึกให้พนักงานทุกคน**
4. ตรวจสอบจำนวนพนักงานและข้อมูลเดิมในหน้าต่างยืนยันก่อนบันทึก

> ระบบจะบันทึกให้เฉพาะพนักงานที่มีสถานะ “เปิดใช้งาน” และหากบุคคลใดมีข้อมูลในวันเดียวกันอยู่แล้ว ข้อมูลเดิมของบุคคลนั้นจะถูกแทนที่
